		 	...
		 	<Container maxWidth="xl">
				<Toolbar disableGutters>
					...
					<Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
						...
						<Button component={Link} to="/library" sx={{ my: 2, color: 'white', display: 'block' }}
							>Library</Button>
						...
						{auth?.role === 'admin'
							?
							<>
								<Button component={Link} to="/editor" sx={{ my: 2, color: 'white', display: 'block' }}
								>Editor</Button>
								<Button component={Link} to="/admin" sx={{ my: 2, color: 'white', display: 'block' }}>Admin</Button>
								
							</>
							: auth?.role === 'editor'
								?
								<Button component={Link} to="/editor" sx={{ my: 2, color: 'white', display: 'block' }}>Editor</Button>
								: null
						}
					</Box>
					<Box sx={{ flexGrow: 0 }}>
