        ...
        <div className="mt-3">
            ...
            <Card className="mt-3">
                <CardContent>
                    ...
                    <Typography gutterBottom variant="h6" sx={{ "font-style": "oblique" }}>3) Use "CREATE LIBRARY RECORD" option to create new library record. While creating library record you can also add tags for it.</Typography>
                </CardContent>
            </Card>
        </div>
	)
