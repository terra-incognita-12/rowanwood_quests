        ...
        <div className="mt-3">
            ...
            <Card className="mt-3">
                <CardContent>
                    ...
                    <Typography gutterBottom variant="h6" sx={{ "font-style": "oblique" }}>4) Make sure you checked new quest 100 times before require activation, because when quest is activated, telegram bot will not synchronized automatically with changes!.</Typography>
                    <Typography gutterBottom variant="h6" sx={{ "font-style": "oblique" }}>4) Only admin can delete quest.</Typography>
                    <Typography gutterBottom variant="h6" sx={{ "font-style": "oblique" }}>5) Use "CREATE LIBRARY RECORD" option to create new library record. While creating library record you can also add tags for it.</Typography>
                </CardContent>
            </Card>
        </div>
	)
